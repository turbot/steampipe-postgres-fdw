...
PG_FUNCTION_INFO_V1(steampipe_net_fdw_handler);
PG_FUNCTION_INFO_V1(steampipe_net_fdw_validator);


Datum steampipe_net_fdw_handler(PG_FUNCTION_ARGS) {
...
Datum steampipe_net_fdw_validator(PG_FUNCTION_ARGS) {
