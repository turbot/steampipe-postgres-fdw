...
require (
	...
	//3820-key-the-rate-limiter-and-plugin-config-maps-by-plugin-image-ref-not-short-name
	github.com/turbot/steampipe v1.7.0-rc.0.0.20230911133821-a75c3b93255f
