...
var testCasesKeyColumnsToPathKeys = map[string]keyColumnsToPathKeysTest{
	...
	"single optional": {
		...
		expected: []PathKey{
			{
				ColumnNames: []string{"id"},
				Rows:        optionaldKeyColumnBaseCost * keyColumnOnlyCostMultiplier,
			},
			{
				ColumnNames: []string{"c1", "id"},
				Rows:        optionaldKeyColumnBaseCost,
			},
			{
				ColumnNames: []string{"c2", "id"},
				Rows:        optionaldKeyColumnBaseCost,
	...
	"multiple optional": {
		...
		expected: []PathKey{
			...
			},
			{
				...
				ColumnNames: []string{"id", "opt1"},
				Rows:        optionaldKeyColumnBaseCost * keyColumnOnlyCostMultiplier,
			},
			{
				ColumnNames: []string{"c1", "id", "opt1"},
				Rows:        optionaldKeyColumnBaseCost,
			},
			{
				ColumnNames: []string{"c2", "id", "opt1"},
				Rows:        optionaldKeyColumnBaseCost,
			}, {
			...
			{
				ColumnNames: []string{"id", "opt2"},
				Rows:        optionaldKeyColumnBaseCost * keyColumnOnlyCostMultiplier,
			},
			{
				ColumnNames: []string{"c1", "id", "opt2"},
				Rows:        optionaldKeyColumnBaseCost,
			},
			{
				ColumnNames: []string{"c2", "id", "opt2"},
				Rows:        optionaldKeyColumnBaseCost,
			}, {
				ColumnNames: []string{"opt1", "opt2"},
				Rows:        optionaldKeyColumnBaseCost * keyColumnOnlyCostMultiplier,
			},
			{
				ColumnNames: []string{"c1", "opt1", "opt2"},
				Rows:        optionaldKeyColumnBaseCost,
			},
			{
				ColumnNames: []string{"c2", "opt1", "opt2"},
				Rows:        optionaldKeyColumnBaseCost,
			}, {
				ColumnNames: []string{"id", "opt1", "opt2"},
				Rows:        optionaldKeyColumnBaseCost * keyColumnOnlyCostMultiplier,
			},
			{
				ColumnNames: []string{"c1", "id", "opt1", "opt2"},
				Rows:        optionaldKeyColumnBaseCost,
			},
			{
				ColumnNames: []string{"c2", "id", "opt1", "opt2"},
				Rows:        optionaldKeyColumnBaseCost,
			},
		},
	},
	...
	"multiple required and multiple optional": {
		...
		expected: []PathKey{
			...
			},
			{
				...
				ColumnNames: []string{"opt1", "opt2", "id", "req1", "req2"},
				Rows:        requiredKeyColumnBaseCost * keyColumnOnlyCostMultiplier,
			},
			{
				ColumnNames: []string{"c1", "opt1", "opt2", "id", "req1", "req2"},
				Rows:        requiredKeyColumnBaseCost,
			},
			{
				ColumnNames: []string{"c2", "opt1", "opt2", "id", "req1", "req2"},
				Rows:        requiredKeyColumnBaseCost,
			},
			{
			...
			},
			{
				...
				ColumnNames: []string{"opt1", "opt3", "id", "req1", "req2"},
				Rows:        requiredKeyColumnBaseCost * keyColumnOnlyCostMultiplier,
			},
			{
				ColumnNames: []string{"c1", "opt1", "opt3", "id", "req1", "req2"},
				Rows:        requiredKeyColumnBaseCost,
			},
			{
				ColumnNames: []string{"c2", "opt1", "opt3", "id", "req1", "req2"},
				Rows:        requiredKeyColumnBaseCost,
			}, {
				ColumnNames: []string{"opt2", "opt3", "id", "req1", "req2"},
				Rows:        requiredKeyColumnBaseCost * keyColumnOnlyCostMultiplier,
			},
			{
				ColumnNames: []string{"c1", "opt2", "opt3", "id", "req1", "req2"},
				Rows:        requiredKeyColumnBaseCost,
			},
			{
				ColumnNames: []string{"c2", "opt2", "opt3", "id", "req1", "req2"},
				Rows:        requiredKeyColumnBaseCost,
			}, {
				ColumnNames: []string{"opt1", "opt2", "opt3", "id", "req1", "req2"},
				Rows:        requiredKeyColumnBaseCost * keyColumnOnlyCostMultiplier,
			},
			{
				ColumnNames: []string{"c1", "opt1", "opt2", "opt3", "id", "req1", "req2"},
				Rows:        requiredKeyColumnBaseCost,
			},
			{
				ColumnNames: []string{"c2", "opt1", "opt2", "opt3", "id", "req1", "req2"},
				Rows:        requiredKeyColumnBaseCost,
			},
		},
	},
